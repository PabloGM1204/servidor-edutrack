...
export interface ApiMesaMesa extends Schema.CollectionType {
  ...
  attributes: {
    NombreMesa: Attribute.String;
    posicion: Attribute.JSON;
    alumnoFK: Attribute.Relation<
      'api::mesa.mesa',
      'oneToOne',
      'api::alumno.alumno'
    >;
    ...
    createdBy: Attribute.Relation<'api::mesa.mesa', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::mesa.mesa', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
